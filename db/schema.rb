...
ActiveRecord::Schema[7.1].define(version: 20_250_902_141_644) do
  ...
  create_table 'events', force: :cascade do |t|
    ...
    t.index %w[subject_type subject_id], name: 'index_events_on_subject'
  end
  ...
  create_table 'walk_logs', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[pet_id date], name: 'index_walk_logs_on_pet_id_and_date', unique: true
  ...
  create_table 'weight_records', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[pet_id date], name: 'index_weight_records_on_pet_id_and_date', unique: true
