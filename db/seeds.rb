...
breeds = [
  ...
  },
  {
    name: 'フレンチブルドッグ',
    risk_tags: {
      '0-120' => %w[呼吸器疾患 皮膚疾患 熱中症注意],
      '12-120' => %w[椎間板ヘルニア 眼疾患]
    }
  },
  {
    name: 'チワワ',
    risk_tags: {
      '0-120' => %w[膝蓋骨脱臼 低血糖 歯周病],
      '60-120' => %w[心疾患 気管虚脱]
    }
  },
  {
  ...
  },
  {
    name: 'パグ',
    risk_tags: {
      '0-120' => %w[呼吸器疾患 眼疾患 熱中症注意],
      '12-120' => %w[椎間板ヘルニア 皮膚疾患]
    }
  },
  {
    name: 'ビーグル',
    risk_tags: {
      '0-120' => %w[肥満注意 耳疾患 皮膚疾患],
      '60-120' => %w[糖尿病 心疾患]
    }
  },
  {
    name: 'ジャーマンシェパード',
    risk_tags: {
      '4-120' => %w[股関節形成不全 肘関節形成不全 胃捻転注意],
      '84-120' => %w[がん 関節炎 神経疾患]
    }
  },
  {
    name: 'ハスキー',
    risk_tags: {
      '0-120' => %w[眼疾患 皮膚疾患 肥満注意],
      '60-120' => %w[甲状腺機能低下症 関節炎]
    }
  },
  {
    name: 'ボーダーコリー',
    risk_tags: {
      '0-120' => %w[眼疾患 てんかん 股関節形成不全],
      '60-120' => %w[認知症 関節炎]
    }
  },
  {
